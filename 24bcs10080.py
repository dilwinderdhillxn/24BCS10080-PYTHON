...
difficulty_config = {
    ...
    "🟡 Medium": {"range": (1, 200), "hints": 4, "max_attempts": 12, "emoji": "🟡"},
    "🔴 Hard": {"range": (1, 500), "hints": 6, "max_attempts": 15, "emoji": "🔴"}
}
...
st.markdown(
    ...
    <div class='footer'>
        ...
        <p style='font-size: 13px; opacity: 0.8;'>Submitted To Supreet Enhanced with modern UI/UX design trends 2025</p>
    </div>
    """,
    unsafe_allow_html=True
)